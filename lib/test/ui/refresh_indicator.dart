...
class RefreshIndicatorNestedScrollView extends StatefulWidget {
  ...
  const RefreshIndicatorNestedScrollView({
    Key key,
    @required this.child,
...
class RefreshIndicator2State extends State<RefreshIndicatorNestedScrollView>
    with TickerProviderStateMixin<RefreshIndicatorNestedScrollView> {
